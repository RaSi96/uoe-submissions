# Why was this uploaded before grading?
This folder contains the source files for my MSc Dissertation. As mentioned in the root's README.md Statement of Academic Honesty:

>  _"All of the work here is [...], uploaded exactly as submitted, [...]"_

With this dissertation being the exception. I discuss why in this document.
...
This is incredibly stupid. I needn't have to remind you, dear reader, that there was once a time when these "standard" scripts were non-standard, yet we, as mathematicians, evolved to inculcate them within our reasoning along with learning how to vocalise them appropriately. It may have been aeons or mere moments ago, but the fact is we learned to accommodate them. I see no reason why Devanagari ought to be sidelined this way, nor Kanji or Hobbit or otherwise, insofar as sensible design decisions have been taken to avoid collision (for example, the use of the Russian к and the Greek $\kappa$). As a matter of fact, that little example directly refutes the requirement of sensible design decisions: both of those letters are very clearly distinct, thanks to modern typography. And, vocalising a certain letter from a "very non-standard" alphabet is also easily accomplished by a simple Google search, if not a [direct reference to Wikipedia](https://en.wikipedia.org/wiki/Hindi#Phonology).

**As such, the source files in this repository contain the use of my original Devanagari script for variables, even though I was forced to replace them in formal submission to the University of Exeter with the mapping presented here.**

If you, upon sufficient self-reflection, would categorise yourself as incredibly stupid, then you will have no problem putting in the extra effort to back up your stupidity by cloning this repo and replacing the occurrences of Devanagari with the mapping presented here. If instead you feel yourself sensible and open to new things like accommodating a new set of alphabet in contemporary mathematical literature, then you will also find here a concise chart giving you the appropriate vocalisation. <u>Either way, you, dear reader, will learn to accept this.</u>

| Devanagari | Vocalisation | Officially Submitted Alternative |
| ---------- | ------------ | -------------------------------- |
| ल          | _L_          | Upsilon: $\Upsilon$              |
| स          | _S_          | Bold-faced H: $\textbf{H}$       |
| प          | _P_          | Variation of rho: $\varrho$      |
